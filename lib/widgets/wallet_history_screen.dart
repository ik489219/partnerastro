      ...
      builder: (signupController) {
        return signupController.astrologerList.isEmpty
            ...
            : signupController.astrologerList.isEmpty ||
                    signupController.astrologerList[0]?.wallet?.isEmpty == true
                ? Column(
                                                                    ...
                                                                    : signupController.astrologerList[0]!.wallet?[index].transactionType ==
                                                                        ...
                                                                        ? Text(
                                                                            signupController.astrologerList[0]?.wallet?[index].name != null
                                                                                ...
                                                                                : tr("Recived gift"),
                                                                            style:
                                                                                Get.theme.primaryTextTheme.displaySmall!.copyWith(fontWeight: FontWeight.normal),
                                                                            textAlign:
                                                                                TextAlign.justify,
                                                                          ).tr(args: [
                                                                        ...
                                                                        : signupController.astrologerList[0]!.wallet![index].transactionType == 'Chat'
                                                                            ? Text(
                                                                                signupController.astrologerList[0]!.wallet![index].name != null ? 'chatwithuser' : tr("Recived gift"),
