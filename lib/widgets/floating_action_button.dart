...
import 'package:astromeet/views/HomeScreen/FloatingButton/AstroBlog/astrology_blog_screen.dart';
import 'package:astromeet/views/HomeScreen/FloatingButton/DailyHoroscope/dailyHoroscopeScreen.dart';
import 'package:astromeet/views/HomeScreen/FloatingButton/FreeKundli/kundliScreen.dart';
import 'package:astromeet/views/HomeScreen/FloatingButton/KundliMatching/kundli_matching_screen.dart';
    ...
    return SpeedDial(
      ...
      speedDialChildren: <SpeedDialChild>[
        SpeedDialChild(
          ...
          onPressed: () async {
            dailyhoroscopeController.selectZodic(0);
