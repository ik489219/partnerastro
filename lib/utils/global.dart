...
String agoraAppId = "f50e5eccd133414ba87741c555598aae";
String agoraAppCertificate = "8eab3861fc73412ebbe0b753eb0e555a";

String agoraChannelName = "";
String agoraToken = "";
String agoraLiveToken = "";
String channelName = "astromeetGuruLive";
String agoraLiveChannelName = "";
String liveChannelName = "astromeetGuruLive";
String agoraChatToken = "";
String agoraChatUserId = "astromeetGuruLive";
String chatChannelName = "astromeetGuruLive";
...
Future<void> sendNotification({
  ...
  try {
    ...
    final url = Uri.parse(
        'https://fcm.googleapis.com/v1/projects/astro-food-pay/messages:send');
...
//         packageName: 'com.astromeet.partner',
//         minimumVersion: 1,
//       ),
//     );
//     Uri url;
