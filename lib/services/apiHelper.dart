...
import 'dart:io';
//models
import 'package:astromeet/models/Notification/storytextmodel.dart';
import 'package:astromeet/models/imageModel.dart';
import 'package:astromeet/models/viewStoryModel.dart';
import 'package:astromeet/views/HomeScreen/FloatingButton/FreeKundli/kundlichartModel.dart';
...
import 'package:astromeet/models/Master%20Table%20Model/get_master_table_list_model.dart';
import 'package:astromeet/models/Notification/notification_model.dart';
import 'package:astromeet/models/app_review_model.dart';
import 'package:astromeet/models/astrologerAssistant_model.dart';
import 'package:astromeet/models/call_model.dart';
import 'package:astromeet/models/chat_model.dart';
import 'package:astromeet/models/customerReview_model.dart';
import 'package:astromeet/models/dailyHororscopeModelVedic.dart';
import 'package:astromeet/models/device_detail_model.dart';
import 'package:astromeet/models/following_model.dart';
import 'package:astromeet/models/hororScopeSignModel.dart';
import 'package:astromeet/models/kundliBasicModel.dart';
import 'package:astromeet/models/kundliModel.dart';
import 'package:astromeet/models/product_category_list_model.dart';
import 'package:astromeet/models/product_model.dart';
import 'package:astromeet/models/report_model.dart';
import 'package:astromeet/models/systemFlagModel.dart';
import 'package:astromeet/models/user_model.dart';
import 'package:astromeet/models/wallet_model.dart';
import 'package:astromeet/models/withdrawOptionModel.dart';
import 'package:astromeet/services/apiResult.dart';
...
class APIHelper {
  ...
  Future<String?> getPrivacyUrl() async {
    try {
      final response = await http.post(
        Uri.parse("https://theastromeet.com/admin/privacy-policy"),
      );
