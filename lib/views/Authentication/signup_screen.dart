...
import 'package:astromeet/constants/messageConst.dart';
import 'package:astromeet/controllers/Authentication/signup_controller.dart';
import 'package:astromeet/controllers/Authentication/signup_otp_controller.dart';
import 'package:astromeet/models/Master%20Table%20Model/all_skill_model.dart';
import 'package:astromeet/models/Master%20Table%20Model/astrologer_category_list_model.dart';
import 'package:astromeet/models/Master%20Table%20Model/language_list_model.dart';
import 'package:astromeet/models/Master%20Table%20Model/primary_skill_model.dart';
import 'package:astromeet/models/time_availability_model.dart';
import 'package:astromeet/models/week_model.dart';
import 'package:astromeet/utils/config.dart';
import 'package:astromeet/views/Authentication/login_screen.dart';
import 'package:astromeet/views/HomeScreen/Drawer/Setting/term_and_condition_screen.dart';
import 'package:astromeet/widgets/app_bar_widget.dart';
import 'package:astromeet/widgets/common_drop_down.dart';
import 'package:astromeet/widgets/common_padding.dart';
import 'package:astromeet/widgets/common_textfield_widget.dart';
import 'package:astromeet/widgets/primary_text_widget.dart';
...
import 'package:astromeet/utils/global.dart' as global;
...
class _SignupScreenState extends State<SignupScreen> {
  ...
  void initState() {
    ...
    otplessFlutterPlugin.setHeadlessCallback(signupController.onHeadlessResult);
  }
                      ...
                      child: Theme(
                        ...
                        child: Stepper(
                          ...
                          steps: <Step>[
                            Step(
                              isActive:
                                  signupController.index >= 0 ? true : false,
                              title: const SizedBox(),
                              content: const SizedBox(),
                            ),
                            Step(
                              isActive:
                                  signupController.index >= 1 ? true : false,
                              title: const SizedBox(),
                              content: const SizedBox(),
                            ),
                            Step(
                              isActive:
                                  signupController.index >= 2 ? true : false,
                              title: const SizedBox(),
                              content: const SizedBox(),
                            ),
                            Step(
                              isActive:
                                  signupController.index >= 3 ? true : false,
                              title: const SizedBox(),
                              content: const SizedBox(),
                            ),
                            Step(
                              isActive:
                                  signupController.index >= 4 ? true : false,
                              title: const SizedBox(),
                              content: const SizedBox(),
                            ),
                          ],
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: CommonTextFieldWidget(
                                      ...
                                      textEditingController:
                                          signupController.cName,
                                      focusNode: signupController.fName,
                                      onFieldSubmitted: (f) {
                                        FocusScope.of(context).requestFocus(
                                            signupController.fEmail);
                                      },
                                    ),
                                  ),
                                  //Email
                                  ...
                                  Padding(
                                    ...
                                    child: CommonTextFieldWidget(
                                      ...
                                      textEditingController:
                                          signupController.cEmail,
                                      focusNode: signupController.fEmail,
                                      onFieldSubmitted: (f) {
                                        FocusScope.of(context).requestFocus(
                                            signupController.fMobileNumber);
                                      },
                                    ),
                                  ),
                                  //Mobile Number
                                  ...
                                  _buildphoneNumberWidget(signupController),
                                  //Term & Condition
                                  Padding(
                                        ...
                                        Obx(
                                          () => Container(
                                            ...
                                            child: Checkbox(
                                              ...
                                              onChanged: (value) {
                                                signupController.termAndCondtion
                                                    .value = value!;
                                              },
                                            ),
                                          ),
                              ...
                              child: ListView(
                                children: [
                                                              ...
                                                              if (i ==
                                                                ...
                                                                signupController
                                                                    ...
                                                                    signupController
                                                                        ...
                                                                        .substring(
                                                                            0,
                                                                            signupController.cSelectCategory.text.length -
                                                                                1); //remove last ","
                                                              }
                                                              signupController
                                                                      .astroId =
                                    ...
                                    child: GetBuilder<SignupController>(
                                        ...
                                        builder: (controller) {
                                          return CommonTextFieldWidget(
                                            ...
                                            textEditingController:
                                                signupController.cPrimarySkill,
                                            obscureText: false,
                                            readOnly: true,
                                            suffixIcon: Icons.arrow_drop_down,
                                            onTap: () {
                                                                ...
                                                                if (i ==
                                                                  ...
                                                                  signupController
                                                                      ...
                                                                      signupController
                                                                          ...
                                                                          .substring(
                                                                              0,
                                                                              signupController.cPrimarySkill.text.length - 1); //remove last ","
                                                                }
                                                                signupController.primaryId = global
                                                                    .skillModelList!
                                                                    .where((element) =>
                                                                        element
                                                                            .isCheck ==
                                  ...
                                  const Padding(
                                    padding: EdgeInsets.only(top: 12),
                                    child:
                                        PrimaryTextWidget(text: "All Skills"),
                                  ),
                                  Padding(
                                    padding: const EdgeInsets.only(top: 8),
                                    child: GetBuilder<SignupController>(
                                        ...
                                        builder: (controller) {
                                          return CommonTextFieldWidget(
                                            hintText:
                                                tr("Choose Your All Skills"),
                                            textEditingController:
                                                signupController.cAllSkill,
                                            obscureText: false,
                                            readOnly: true,
                                            suffixIcon: Icons.arrow_drop_down,
                                            onTap: () {
                                                          ...
                                                          child:
                                                            ...
                                                            itemBuilder:
                                                              ...
                                                              return CheckboxListTile(
                                                                ...
                                                                title: Text(
                                                                  global.allSkillModelList![index]
                                                                          .name ??
                                                                      tr("No Skills"),
                                                                  style: Get
                                                                      .theme
                                                                ...
                                                                if (i ==
                                                                  ...
                                                                  signupController
                                                                      ...
                                                                      signupController
                                                                          ...
                                                                          .substring(
                                                                              0,
                                                                              signupController.cAllSkill.text.length - 1); //remove last ","
                                                                }
                                                                signupController.allId = global
                                                                    .allSkillModelList!
                                                                    .where((element) =>
                                                                        element
                                                                            .isCheck ==
                                                          ...
                                                          child:
                                                            ...
                                                            itemBuilder:
                                                              ...
                                                              return CheckboxListTile(
                                                                ...
                                                                title: Text(
                                                                  global.languageModelList![index]
                                                                          .name ??
                                                                      tr("No Skills"),
                                                                  style: Get
                                                                      .theme
                                                                ...
                                                                if (i ==
                                                                  ...
                                                                  signupController
                                                                      ...
                                                                      signupController
                                                                          ...
                                                                          .substring(
                                                                              0,
                                                                              signupController.cLanguage.text.length - 1); //remove last ","
                                                                }
                                                                signupController.lId = global
                                                                    .languageModelList!
                                                                    .where((element) =>
                                                                        element
                                                                            .isCheck ==
                                  ...
                                  const Padding(
                                    ...
                                    child: PrimaryTextWidget(
                                        text:
                                            "Add your charge's (as per Minute)"),
                                  ),
                                  Padding(
                                    padding: const EdgeInsets.only(top: 5.0),
                                    child: CommonTextFieldWidget(
                                      textEditingController:
                                          signupController.cCharges,
                                      ...
                                      onFieldSubmitted: (f) {
                                        FocusScope.of(context).requestFocus(
                                            signupController.fVideoCharges);
                                      },
                                      hintText:
                                  ...
                                  const Padding(
                                    padding: EdgeInsets.only(top: 12),
                                    child: PrimaryTextWidget(
                                        text: "Add your video charge's"),
                                  ),
                                  Padding(
                                    padding: const EdgeInsets.only(top: 5.0),
                                    child: CommonTextFieldWidget(
                                      textEditingController:
                                          signupController.cVideoCharges,
                                      focusNode: signupController.fVideoCharges,
                                      counterText: '',
                                      maxLength: 4,
                                      onFieldSubmitted: (f) {
                                        FocusScope.of(context).requestFocus(
                                            signupController.fReportCharges);
                                      },
                                      hintText:
                                          "${global.getSystemFlagValue(global.systemFlagNameList.currency)}20",
                                      keyboardType:
                                  ...
                                  const Padding(
                                    padding: EdgeInsets.only(top: 12),
                                    child: PrimaryTextWidget(
                                        text: "Add your report charge's"),
                                  ),
                                  Padding(
                                    padding: const EdgeInsets.only(top: 5.0),
                                    child: CommonTextFieldWidget(
                                      textEditingController:
                                          signupController.cReportCharges,
                                      focusNode:
                                          signupController.fReportCharges,
                                      counterText: '',
                                      maxLength: 4,
                                  ...
                                  Padding(
                                    ...
                                    child: CommonTextFieldWidget(
                                      ...
                                      hintText: tr("Enter Your Expirence"),
                                      keyboardType:
                                          const TextInputType.numberWithOptions(
                                              decimal: true, signed: true),
                                    ),
                                  ...
                                  Padding(
                                    ...
                                    child: CommonTextFieldWidget(
                                      textEditingController:
                                          signupController.cContributionHours,
                                      focusNode:
                                      ...
                                      hintText:
                                          tr("Enter your contribution daily"),
                                      keyboardType:
                                          const TextInputType.numberWithOptions(
                                              decimal: true, signed: true),
                                    ),
                                  ...
                                  Padding(
                                    ...
                                    child: CommonTextFieldWidget(
                                      ...
                                      focusNode:
                                          signupController.fHearAboutAstroGuru,
                                      onFieldSubmitted: (f) {
                                        FocusScope.of(context).unfocus();
                                      },
                                      textEditingController:
                                          signupController.cHearAboutAstroGuru,
                              ...
                              child: ListView(
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: CommonTextFieldWidget(
                                      hintText:
                                          tr("Why we should on board you?"),
                                      textEditingController:
                                          signupController.cOnBoardYou,
                                      ...
                                      onFieldSubmitted: (f) {
                                        FocusScope.of(context).requestFocus(
                                            signupController.fTimeForInterview);
                                      },
                                    ),
                                  ),
                                  //Time for Interview
                                  ...
                                  Padding(
                                    ...
                                    child: CommonTextFieldWidget(
                                      hintText: tr(
                                          "Enter Suitable Time For Interview"),
                                      textEditingController:
                                          signupController.cTimeForInterview,
                                      focusNode:
                                          signupController.fTimeForInterview,
                                      onFieldSubmitted: (f) {
                                        FocusScope.of(context).requestFocus(
                                            signupController.fLiveCity);
                                      },
                                    ),
                                  ),
                                  //Live City
                                  ...
                                  Padding(
                                    ...
                                    child: CommonDropDown(
                                      ...
                                      onTap: () {},
                                      onChanged: (selectedValue) {
                                        signupController.selectedDegreeDiploma =
                                            selectedValue;
                                        signupController.update();
                                      },
                                    ),
                                  ...
                                  Padding(
                                    ...
                                    child: CommonTextFieldWidget(
                                      hintText: tr(
                                          "Enter your College/School/University Name"),
                                      textEditingController: signupController
                                          .cCollegeSchoolUniversity,
                                      focusNode: signupController
                                          .fCollegeSchoolUniversity,
                                      formatter: [
                                        FilteringTextInputFormatter.allow(
                                            RegExp("[a-zA-Z ]"))
                                      ],
                                      onFieldSubmitted: (f) {
                                        FocusScope.of(context).requestFocus(
                                            signupController.fLearnAstroLogy);
                                      },
                                    ),
                                  ),
                                  //Learn Astrology
                                  ...
                                  Padding(
                                    ...
                                    child: CommonTextFieldWidget(
                                      hintText: tr(
                                          "From where did you learn Astrology?"),
                                      textEditingController:
                                          signupController.cLearnAstrology,
                                      formatter: [
                                        FilteringTextInputFormatter.allow(
                                            RegExp("[a-zA-Z ]"))
                                      ],
                                  ...
                                  Padding(
                                    ...
                                    child: CommonTextFieldWidget(
                                      hintText: tr(
                                          "Please let us know your instagram profile"),
                                      textEditingController:
                                          signupController.cInsta,
                                      focusNode: signupController.fInsta,
                                      onFieldSubmitted: (f) {
                                        FocusScope.of(context).requestFocus(
                                            signupController.fFacebook);
                                      },
                                    ),
                                  ),
                                  //Facebook
                                  ...
                                  Padding(
                                    ...
                                    child: CommonTextFieldWidget(
                                      hintText: tr(
                                          "Please let us know your Facebook profile"),
                                      textEditingController:
                                          signupController.cFacebook,
                                      focusNode: signupController.fFacebook,
                                      onFieldSubmitted: (f) {
                                        FocusScope.of(context).requestFocus(
                                            signupController.fLinkedIn);
                                      },
                                    ),
                                  ),
                                  //LinkedIn
                                  ...
                                  Padding(
                                    ...
                                    child: CommonTextFieldWidget(
                                      hintText: tr(
                                          "Please let us know your LinkedIn profile"),
                                      textEditingController:
                                          signupController.cLinkedIn,
                                      focusNode: signupController.fLinkedIn,
                                      onFieldSubmitted: (f) {
                                        FocusScope.of(context).requestFocus(
                                            signupController.fYoutube);
                                      },
                                    ),
                                  ),
                                  //Youtube
                                  ...
                                  Padding(
                                    ...
                                    child: CommonTextFieldWidget(
                                      hintText: tr(
                                          "Please let us know your Youtube profile"),
                                      textEditingController:
                                          signupController.cYoutube,
                                      focusNode: signupController.fYoutube,
                                      onFieldSubmitted: (f) {
                                        FocusScope.of(context).requestFocus(
                                            signupController.fWebSite);
                                      },
                                    ),
                                  ),
                                  //WebSite
                                  ...
                                  Padding(
                                    ...
                                    child: CommonTextFieldWidget(
                                      hintText: tr(
                                          "Please let us know your Website profile"),
                                      textEditingController:
                                          signupController.cWebSite,
                                                  ...
                                                  child: CommonTextFieldWidget(
                                                    ...
                                                    onFieldSubmitted: (f) {
                                                      FocusScope.of(context)
                                                          .requestFocus(
                                                              signupController
                                                                  .fExpectedMinimumEarning);
                                                    },
                                                    hintText:
                                                        tr("Refer person name"),
                                                  ),
                                                ),
                                              ],
                                            ),
                                  ...
                                  const Padding(
                                    ...
                                    child: PrimaryTextWidget(
                                        text:
                                            "Minimum Earning Expectation from Us"),
                                  ),
                                  Padding(
                                    padding: const EdgeInsets.only(top: 5.0),
                                    child: CommonTextFieldWidget(
                                  ...
                                  const Padding(
                                    ...
                                    child: PrimaryTextWidget(
                                        text:
                                            "Maximum Earning Expectation from Us"),
                                  ),
                                  Padding(
                                    padding: const EdgeInsets.only(top: 5.0),
                                    child: CommonTextFieldWidget(
                              ...
                              child: ListView(
                                children: [
                                  ...
                                  const Padding(
                                    ...
                                    child: PrimaryTextWidget(
                                        text:
                                            "What are some good qualities of a perfect astrologer?"),
                                  ),
                                  Padding(
                                    padding: const EdgeInsets.only(top: 5.0),
                                    child: CommonTextFieldWidget(
                                      maxLines: 5,
                                      textEditingController:
                                          signupController.cGoodQuality,
                                      focusNode: signupController.fGoodQuality,
                                      onFieldSubmitted: (f) {
                                        FocusScope.of(context).requestFocus(
                                            signupController.fBiggestChallenge);
                                      },
                                  ...
                                  Padding(
                                    ...
                                    child: CommonTextFieldWidget(
                                      maxLines: 5,
                                      textEditingController:
                                          signupController.cBiggestChallenge,
                                      focusNode:
                                          signupController.fBiggestChallenge,
                                      onFieldSubmitted: (f) {
                                        FocusScope.of(context).requestFocus(
                                            signupController.fRepeatedQuestion);
                                      },
                                      hintText: tr("Describe Here"),
                                    ),
                                  ),
                                  ...
                                  Padding(
                                    ...
                                    child: CommonTextFieldWidget(
                                      maxLines: 5,
                                      textEditingController:
                                          signupController.cRepeatedQuestion,
                                      focusNode:
                                          signupController.fRepeatedQuestion,
                                      onFieldSubmitted: (f) {
                                        FocusScope.of(context).unfocus();
                                                            ...
                                                            child: Container(
                                                              ...
                                                              child: Stack(
                                                                alignment: Alignment
                                                                    .centerRight,
                                                                children: [
                                                                  signupController.week![index].timeAvailabilityList![i].fromTime !=
                                                                              "" &&
                                                                          signupController.week![index].timeAvailabilityList![i].fromTime !=
                                                                              null
                                                                      ? signupController.week![index].timeAvailabilityList!.length !=
                                                                              1
                                                                          ? Padding(
                                                                              ...
                                                                              child: GestureDetector(
                                                                                onTap: () {
                                                                                  Get.dialog(
                                                                                    AlertDialog(
                                                                                      title: const Text("Are you sure you want delete this time?").tr(),
                                                                                      content: Row(
                                                                                        children: [
                                                                                          Expanded(
                                                                                            flex: 4,
                                                                  ...
                                                                  Center(
                                                                    child: Text(
                                                                      signupController.week![index].timeAvailabilityList![i].fromTime != "" &&
                                                                              signupController.week![index].timeAvailabilityList![i].fromTime != null
                                                                          ? "${signupController.week![index].timeAvailabilityList![i].fromTime} - "
                                                                              "${signupController.week![index].timeAvailabilityList![i].toTime}"
                                                                          : "",
                                                                    ),
                                                                  ),
                                                                ],
...
//Availability Dialog
            ...
            onPressed: () {
              if (isTapDay == "Sunday") {
                for (int j = 0;
                    j <
                        signupController
                            .week![widgetIndex].timeAvailabilityList!.length;
                    j++) {
                  if (signupController.week![widgetIndex]
                          .timeAvailabilityList![j].fromTime ==
                      "") {
                    signupController.week![widgetIndex].timeAvailabilityList![j]
                        .fromTime = signupController.cStartTime.text;
                    signupController.week![widgetIndex].timeAvailabilityList![j]
                        .toTime = signupController.cEndTime.text;
                  }
                }
                ...
                global.showToast(message: tr("Please Select Any One Time"));
              }
  ...
  Container _buildphoneNumberWidget(SignupController signupcontroller) {
    return Container(
        ...
        child: Theme(
          ...
          child: SizedBox(
            child: InternationalPhoneNumberInput(
              ...
              textFieldController: signupcontroller.cMobileNumber,
              ...
              onSaved: (PhoneNumber number) {
                ...
                signupcontroller.updateCountryCode(number.dialCode);
                signupcontroller.update();
                signupcontroller
                    .updatephoneno(signupcontroller.cMobileNumber.text);
                signupcontroller.update();
              },
