...
import 'package:astromeet/views/HomeScreen/FloatingButton/AstroBlog/astrology_blog_detil_screen.dart';
import 'package:astromeet/views/HomeScreen/search_blog_screen.dart';
import 'package:astromeet/widgets/app_bar_widget.dart';
import 'package:astromeet/widgets/common_padding_2.dart';
                                            ...
                                            : blogController
                                                ...
                                                ? Stack(
                                                    ...
                                                    children: [
                                                      CachedNetworkImage(
                                                        imageUrl:
                                                            '$imgBaseurl${blogController.astrologyBlogs[index].previewImage}',
                                                ...
                                                : CachedNetworkImage(
                                                    imageUrl:
                                                        '$imgBaseurl${blogController.astrologyBlogs[index].blogImage}',
                                                    imageBuilder: (context,
                                                            imageProvider) =>
                                                        Container(
                                                      height: 180,
