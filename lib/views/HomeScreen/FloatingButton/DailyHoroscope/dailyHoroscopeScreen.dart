...
import 'package:astromeet/views/HomeScreen/FloatingButton/DailyHoroscope/dailyHoroScopeDetailScreen.dart';
                                              ...
                                              dailyHoroscopeController
                                                  ...
                                                  ? Container(
                                                      ...
                                                      child: Image.network(
                                                        ...
                                                        '$imgBaseurl${dailyHoroscopeController.dailyList!.yeasterdayInsight![index].coverImage != null ? dailyHoroscopeController.dailyList!.yeasterdayInsight![index].coverImage : SizedBox()}',
                                                        fit: BoxFit.cover,
                                                      ),
                                                    )
                                                  : const SizedBox(),
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  Container(
                                                    ...
                                                    child: Image.network(
                                                      '$imgBaseurl${dailyHoroscopeController.dailyList!.todayInsight![1].coverImage}',
                                                      fit: BoxFit.cover,
                                                    ),
                                                  ),
                                                  const SizedBox(
                                                      ...
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          Container(
                                                            ...
                                                            child:
                                                                Image.network(
                                                              '$imgBaseurl${dailyHoroscopeController.dailyList!.tomorrowInsight![2].coverImage}',
                                                              fit: BoxFit.cover,
                                                            ),
                                                          ),
                                                          const SizedBox(
                                                ...
                                                children: [
                                                  Container(
                                                    ...
                                                    padding:
                                                        const EdgeInsets.all(8),
                                                    child: Image.network(
                                                      '$imgBaseurl${dailyHoroscopeController.dailyList!.todayInsight![index].coverImage}',
                                                      fit: BoxFit.cover,
                                                    ),
                                                  ),
                                                  const SizedBox(
                                                      ...
                                                      Container(
                                                        ...
                                                        padding:
                                                            const EdgeInsets
                                                                .all(8),
                                                        child: Image.network(
                                                          '$imgBaseurl${dailyHoroscopeController.dailyList!.tomorrowInsight![index].coverImage}',
                                                          fit: BoxFit.cover,
                                                        ),
                                                      ),
                                                      const SizedBox(
