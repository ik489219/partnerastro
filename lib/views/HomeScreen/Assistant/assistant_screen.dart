...
import 'package:astromeet/views/HomeScreen/Assistant/add_or_edit_assistant_screen.dart';
import 'package:astromeet/views/HomeScreen/Assistant/assistant_detail_screen.dart';
      ...
      child: SafeArea(
        child: Scaffold(
          appBar: MyCustomAppBar(
            ...
            title: const Text("My Assistant").tr(),
            actions: [
                                    ...
                                    : Container(
                                        ...
                                        decoration: BoxDecoration(
                                          ...
                                          image: DecorationImage(
                                            fit: BoxFit.cover,
                                            image: NetworkImage(
                                                "$imgBaseurl${assistantController.astrologerAssistantList[index].profile}"),
                                          ),
                                        ),
                                      ),
                                title: Column(
